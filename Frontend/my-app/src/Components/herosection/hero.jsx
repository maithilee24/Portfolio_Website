        ...
        <div className="relative">
            ...
            <div className="z-20 flex flex-col">
                ...
                <div className="flex flex-row absolute left-8 sm:left-24 top-5 sm:top-20 md:top-24 lg:top-32 xl:top-40 justify-center items-center">
                    <div className="text-white text-[1.6rem] leading-6 sm:text-4xl  md:text-5xl xl:text-6xl font-bold">MAITHILEE PARDHI</div>
                    <div><img src={V2} alt="" className="h-14 sm:h-auto"></img></div>
                </div>
                <div className="text-white text-[0.7rem] sm:text-sm md:text-base lg:text-lg xl:text-xl absolute left-8 sm:left-24 top-[4rem] sm:top-[9.5rem] md:top-44 lg:top-52 xl:top-60 italic font-light">Web Developer ,UI-UX Designer and Graphic Designer</div>
            </div>
        </div>
    )
}
