        ...
        <div className="flex flex-col h-[250vh] sm:h-[170vh] md:h-[190vh] lg:h-[200vh] xl:h-[205vh] mt-8 bg-gradient-to-r from-[#4A39C3] to-[#509AD7] rounded-t-[4rem] sm:rounded-t-[10rem]  lg:rounded-t-[12rem]">
            ...
            <div className="flex flex-col sm:flex-row mx-10 sm:mx-16 md:mx-24 lg:mx-40 mt-6 sm:mt-12 md:mt-16 lg:mt-20 ">
                <div className="flex flex-col sm:w-1/2">
                        <div className="text-white text-xl sm:text-xl md:text-2xl lg:text-3xl font-medium mb-2 sm:mb-3">DON'T BE SHY!</div>
                        <div className="text-white text-sm sm:text-[0.8rem] lg:text-[0.95rem] font-light italic sm:mr-16 mb-2 sm:mb-3">"Let's make something great together! Contact me for collaborations, freelance opportunities, or any inquiries about my work. I'm looking forward to hearing from you."</div>
                ...
                <div className="flex flex-row mt-6 sm:mt-0 sm:w-1/2 justify-center items-center relative">
                        <div className="absolute -top-6 sm:-top-14 -left-2 sm:left-6 z-30"><img src={V1} alt="" className="h-16 sm:h-auto"></img></div>
            ...
            <div className="flex flex-col relative">
                ...
                <div className="absolute z-0 top-32 sm:top-0"><img src={V2} alt=""></img></div>
            </div>
        </div>
    )
}
