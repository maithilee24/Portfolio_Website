...
const Navbar=()=>{
    ...
    return <nav className="flex flex-row z-30">
        ...
        <div className=" hidden sm:flex flex-row top text-white text-base font-light sm:space-x-4 md:space-x-7 lg:space-x-8 xl:space-x-14 justify-end items-center sm:ml-[16%] md:ml-[25%] lg:ml-[35%] xl:ml-[40%]">
